...
public final class ItemEditorKeybinds {
    ...
    private static final KeyMapping OPEN_STORAGE = KeyBindingHelper.registerKeyBinding(new KeyMapping(
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            while (OPEN_STORAGE.consumeClick()) {
                if (client.player != null && client.level != null) {
                    client.setScreen(new StorageScreen());
                }
            }
            while (OPEN_STORAGE_PAGES.consumeClick()) {
                if (client.player != null && client.level != null) {
                    client.setScreen(new StoragePagesScreen(client, null));
                }
            }
        });
    }
