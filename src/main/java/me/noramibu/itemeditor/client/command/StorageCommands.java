...
public final class StorageCommands {
    ...
    public static void register() {
        ClientCommandRegistrationCallback.EVENT.register(
                (dispatcher, access) -> dispatcher.register(ClientCommands.literal("storage")
                        .executes(context -> openStorage(context, 1, "", StorageSortMode.REGULAR))
                        .then(ClientCommands.literal("pages").executes(StorageCommands::openStoragePages))
    ...
    private static int openStoragePages(CommandContext<FabricClientCommandSource> context) {
        ...
        minecraft.execute(() -> minecraft.setScreenAndShow(new StoragePagesScreen(minecraft, null)));
        return 1;
    }
